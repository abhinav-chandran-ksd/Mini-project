...
# --- CONFIGURATION ---
FOLDER_PATH = "/dataset"     # Folder containing your 10 images
MY_NAME = "Admin"         # The name you want in the database
...
def enroll_face():
    ...
    try:
        ...
        if data:
            ...
            cursor.execute("INSERT INTO face_data (name, encoding) VALUES (?, ?)", (MY_NAME, vector_json))
